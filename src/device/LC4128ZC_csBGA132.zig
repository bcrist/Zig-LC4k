//[[!! include('devices', 'LC4128ZC_csBGA132') !! 978 ]]
...
pub const pins = struct {
    pub const A1 = Pin.init_io(0, "A1", 0, .io_A14);
    pub const A2 = Pin.init_io(1, "A2", 0, .io_A13);
    pub const A3 = Pin.init_io(2, "A3", 0, .io_A10);
    ...
    pub const A8 = Pin.init_oe(7, "A8", 1, .io_H0, 1);
    pub const A9 = Pin.init_io(8, "A9", 1, .io_H2);
    pub const A10 = Pin.init_misc(9, "A10", 1, .vcco);
    pub const A11 = Pin.init_io(10, "A11", 1, .io_H9);
    pub const A12 = Pin.init_io(11, "A12", 1, .io_H13);
    ...
    pub const B3 = Pin.init_io(16, "B3", 0, .io_A12);
    pub const B4 = Pin.init_misc(17, "B4", 0, .gndo);
    pub const B5 = Pin.init_io(18, "B5", 0, .io_A5);
    pub const B6 = Pin.init_io(19, "B6", 0, .io_A2);
    pub const B7 = Pin.init_misc(20, "B7", null, .vcc_core);
    pub const B8 = Pin.init_clk(21, "B8", 1, .clk3, 3, 7);
    pub const B9 = Pin.init_io(22, "B9", 1, .io_H4);
    pub const B10 = Pin.init_io(23, "B10", 1, .io_H6);
    pub const B11 = Pin.init_misc(24, "B11", 1, .gndo);
    pub const B12 = Pin.init_io(25, "B12", 1, .io_H10);
    pub const B13 = Pin.init_io(26, "B13", 1, .io_H14);
    pub const B14 = Pin.init_misc(27, "B14", null, .tdo);
    pub const C1 = Pin.init_misc(28, "C1", 0, .vcco);
    pub const C2 = Pin.init_io(29, "C2", 0, .io_B1);
    pub const C3 = Pin.init_io(30, "C3", 0, .io_B0);
    pub const C4 = Pin.init_io(31, "C4", 0, .io_A9);
    pub const C5 = Pin.init_misc(32, "C5", 0, .vcco);
    pub const C6 = Pin.init_io(33, "C6", 0, .io_A4);
    pub const C7 = Pin.init_oe(34, "C7", 0, .io_A0, 0);
    pub const C8 = Pin.init_clk(35, "C8", 0, .clk0, 0, 0);
    pub const C9 = Pin.init_io(36, "C9", 1, .io_H1);
    pub const C10 = Pin.init_io(37, "C10", 1, .io_H5);
    pub const C11 = Pin.init_io(38, "C11", 1, .io_H8);
    pub const C12 = Pin.init_io(39, "C12", 1, .io_H12);
    pub const C13 = Pin.init_misc(40, "C13", 1, .vcco);
    pub const C14 = Pin.init_io(41, "C14", 1, .io_G0);
    pub const D1 = Pin.init_io(42, "D1", 0, .io_B2);
    pub const D2 = Pin.init_io(43, "D2", 0, .io_B5);
    pub const D3 = Pin.init_io(44, "D3", 0, .io_B4);
    pub const D12 = Pin.init_io(45, "D12", 1, .io_G1);
    pub const D13 = Pin.init_io(46, "D13", 1, .io_G4);
    pub const D14 = Pin.init_io(47, "D14", 1, .io_G2);
    pub const E1 = Pin.init_io(48, "E1", 0, .io_B6);
    pub const E2 = Pin.init_misc(49, "E2", 0, .gndo);
    pub const E3 = Pin.init_io(50, "E3", 0, .io_B8);
    pub const E12 = Pin.init_io(51, "E12", 1, .io_G5);
    pub const E13 = Pin.init_misc(52, "E13", 1, .gndo);
    pub const E14 = Pin.init_io(53, "E14", 1, .io_G6);
    pub const F1 = Pin.init_io(54, "F1", 0, .io_B10);
    pub const F2 = Pin.init_io(55, "F2", 0, .io_B9);
    pub const F3 = Pin.init_io(56, "F3", 0, .io_B12);
    pub const F12 = Pin.init_io(57, "F12", 1, .io_G8);
    pub const F13 = Pin.init_io(58, "F13", 1, .io_G9);
    pub const F14 = Pin.init_io(59, "F14", 1, .io_G10);
    pub const G1 = Pin.init_io(60, "G1", 0, .io_B13);
    pub const G2 = Pin.init_io(61, "G2", 0, .io_B14);
    pub const G3 = Pin.init_misc(62, "G3", 0, .vcco);
    pub const G12 = Pin.init_io(63, "G12", 1, .io_G12);
    pub const G13 = Pin.init_io(64, "G13", 1, .io_G14);
    pub const G14 = Pin.init_io(65, "G14", 1, .io_G13);
    pub const H1 = Pin.init_io(66, "H1", 0, .io_C13);
    pub const H2 = Pin.init_io(67, "H2", 0, .io_C14);
    pub const H3 = Pin.init_io(68, "H3", 0, .io_C12);
    pub const H12 = Pin.init_misc(69, "H12", 1, .vcco);
    pub const H13 = Pin.init_io(70, "H13", 1, .io_F14);
    pub const H14 = Pin.init_io(71, "H14", 1, .io_F13);
    pub const J1 = Pin.init_io(72, "J1", 0, .io_C10);
    pub const J2 = Pin.init_io(73, "J2", 0, .io_C9);
    pub const J3 = Pin.init_io(74, "J3", 0, .io_C8);
    pub const J12 = Pin.init_io(75, "J12", 1, .io_F12);
    pub const J13 = Pin.init_io(76, "J13", 1, .io_F9);
    pub const J14 = Pin.init_io(77, "J14", 1, .io_F10);
    pub const K1 = Pin.init_io(78, "K1", 0, .io_C6);
    pub const K2 = Pin.init_misc(79, "K2", 0, .gndo);
    pub const K3 = Pin.init_io(80, "K3", 0, .io_C5);
    pub const K12 = Pin.init_io(81, "K12", 1, .io_F8);
    pub const K13 = Pin.init_misc(82, "K13", 1, .gndo);
    pub const K14 = Pin.init_io(83, "K14", 1, .io_F6);
    pub const L1 = Pin.init_io(84, "L1", 0, .io_C2);
    pub const L2 = Pin.init_io(85, "L2", 0, .io_C4);
    pub const L3 = Pin.init_io(86, "L3", 0, .io_C1);
    pub const L12 = Pin.init_io(87, "L12", 1, .io_F4);
    pub const L13 = Pin.init_io(88, "L13", 1, .io_F5);
    pub const L14 = Pin.init_io(89, "L14", 1, .io_F2);
    pub const M1 = Pin.init_io(90, "M1", 0, .io_C0);
    pub const M2 = Pin.init_misc(91, "M2", 0, .vcco);
    pub const M3 = Pin.init_io(92, "M3", 0, .io_D12);
    pub const M4 = Pin.init_io(93, "M4", 0, .io_D8);
    pub const M5 = Pin.init_io(94, "M5", 0, .io_D5);
    pub const M6 = Pin.init_io(95, "M6", 0, .io_D1);
    pub const M7 = Pin.init_clk(96, "M7", 1, .clk2, 2, 4);
    pub const M8 = Pin.init_io(97, "M8", 1, .io_E0);
    pub const M9 = Pin.init_io(98, "M9", 1, .io_E4);
    pub const M10 = Pin.init_misc(99, "M10", 1, .vcco);
    pub const M11 = Pin.init_io(100, "M11", 1, .io_E9);
    pub const M12 = Pin.init_io(101, "M12", 1, .io_F0);
    pub const M13 = Pin.init_io(102, "M13", 1, .io_F1);
    pub const M14 = Pin.init_misc(103, "M14", 1, .vcco);
    pub const N1 = Pin.init_misc(104, "N1", null, .tck);
    pub const N2 = Pin.init_io(105, "N2", 0, .io_D14);
    pub const N3 = Pin.init_io(106, "N3", 0, .io_D10);
    pub const N4 = Pin.init_misc(107, "N4", 0, .gndo);
    pub const N5 = Pin.init_io(108, "N5", 0, .io_D6);
    pub const N6 = Pin.init_io(109, "N6", 0, .io_D4);
    pub const N7 = Pin.init_clk(110, "N7", 0, .clk1, 1, 3);
    pub const N8 = Pin.init_misc(111, "N8", null, .vcc_core);
    pub const N9 = Pin.init_io(112, "N9", 1, .io_E2);
    pub const N10 = Pin.init_io(113, "N10", 1, .io_E5);
    pub const N11 = Pin.init_misc(114, "N11", 1, .gndo);
    pub const N12 = Pin.init_io(115, "N12", 1, .io_E12);
    ...
    pub const P3 = Pin.init_io(120, "P3", 0, .io_D13);
    pub const P4 = Pin.init_io(121, "P4", 0, .io_D9);
    pub const P5 = Pin.init_misc(122, "P5", 0, .vcco);
    pub const P6 = Pin.init_io(123, "P6", 0, .io_D2);
    pub const P7 = Pin.init_io(124, "P7", 0, .io_D0);
    pub const P8 = Pin.init_misc(125, "P8", null, .no_connect);
    pub const P9 = Pin.init_io(126, "P9", 1, .io_E1);
    pub const P10 = Pin.init_io(127, "P10", 1, .io_E6);
    pub const P11 = Pin.init_io(128, "P11", 1, .io_E8);
    pub const P12 = Pin.init_io(129, "P12", 1, .io_E10);
    pub const P13 = Pin.init_io(130, "P13", 1, .io_E13);
    pub const P14 = Pin.init_io(131, "P14", 1, .io_E14);
};
