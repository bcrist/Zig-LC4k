//[[!! include('devices', 'LC4032ZE_TQFP48') !! 492 ]]
...
pub const device_type = lc4k.Device_Type.LC4032ZE_TQFP48;
...
var name_buf: [14336]u8 = undefined;
...
pub const pins = struct {
    ...
    pub const _10 = Pin.init_io(9, "10", 0, .io_A11);
    ...
    pub const _14 = Pin.init_io(13, "14", 0, .io_A12);
    pub const _15 = Pin.init_io(14, "15", 0, .io_A13);
    pub const _16 = Pin.init_io(15, "16", 0, .io_A14);
    pub const _17 = Pin.init_io(16, "17", 0, .io_A15);
    pub const _18 = Pin.init_clk(17, "18", 0, .clk1, 1, 0);
    pub const _19 = Pin.init_clk(18, "19", 1, .clk2, 2, 1);
    pub const _20 = Pin.init_io(19, "20", 1, .io_B0);
    pub const _21 = Pin.init_io(20, "21", 1, .io_B1);
    pub const _22 = Pin.init_io(21, "22", 1, .io_B2);
    pub const _23 = Pin.init_io(22, "23", 1, .io_B3);
    pub const _24 = Pin.init_io(23, "24", 1, .io_B4);
    pub const _25 = Pin.init_misc(24, "25", null, .tms);
    pub const _26 = Pin.init_io(25, "26", 1, .io_B5);
    pub const _27 = Pin.init_io(26, "27", 1, .io_B6);
    pub const _28 = Pin.init_io(27, "28", 1, .io_B7);
    pub const _29 = Pin.init_misc(28, "29", 1, .gndo);
    pub const _30 = Pin.init_misc(29, "30", 1, .vcco);
    pub const _31 = Pin.init_io(30, "31", 1, .io_B8);
    pub const _32 = Pin.init_io(31, "32", 1, .io_B9);
    pub const _33 = Pin.init_io(32, "33", 1, .io_B10);
    pub const _34 = Pin.init_io(33, "34", 1, .io_B11);
    ...
    pub const _38 = Pin.init_io(37, "38", 1, .io_B12);
    pub const _39 = Pin.init_io(38, "39", 1, .io_B13);
    pub const _40 = Pin.init_io(39, "40", 1, .io_B14);
    pub const _41 = Pin.init_oe(40, "41", 1, .io_B15, 1);
    pub const _42 = Pin.init_clk(41, "42", 1, .clk3, 3, 1);
    ...
    pub const _47 = Pin.init_io(46, "47", 0, .io_A3);
