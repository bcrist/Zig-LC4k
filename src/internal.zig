...
pub fn getSpecialPT(
    ...
    return switch (pt_index) {
        0 => switch (mc_config.xor) {
            .none, .invert, .input => null,
            .pt0, .pt0_inverted => |pt| pt,
        },
        1 => switch (mc_config.clock) {
            .none, .shared_pt_clock, .bclock => null,
            .pt1_positive, .pt1_negative => |pt| pt,
        },
        2 => switch (mc_config.ce) {
            .always_active, .shared_pt_clock => switch (mc_config.async_source) {
                .none => null,
                .pt2_active_high => |pt| pt,
            },
            .pt2_active_low, .pt2_active_high => |pt| pt,
        },
        3 => switch (mc_config.init_source) {
            .shared_pt_init => null,
