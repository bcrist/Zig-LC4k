...
pub const device_type = lc4k.DeviceType.LC4128ZE_ucBGA132;

pub const family = lc4k.DeviceFamily.zero_power_enhanced;
pub const package = lc4k.DevicePackage.ucBGA132;
...
pub const pins = struct {
    ...
    pub const J8 = lc4k.PinInfo {
        .id = "J8",
        .func = .{ .io = 4 },
        .glb = 4,
        .grp_ordinal = @intFromEnum(GRP.io_E4),
    };
    pub const J9 = lc4k.PinInfo {
        .id = "J9",
        .func = .{ .gnd = {} },
    };
