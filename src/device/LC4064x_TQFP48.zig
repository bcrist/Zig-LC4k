...
var name_buf: [22528]u8 = undefined;
...
pub fn get_gi_range(glb: usize, gi: usize) Fuse_Range {
    ...
    return get_glb_range(glb).expand_columns(-5).sub_columns(0, 5).sub_rows(gi * 2, 2);
}
...
pub const pins = struct {
    ...
    pub const _10 = Pin.init_io(9, "10", 0, .io_B6);
    ...
    pub const _14 = Pin.init_io(13, "14", 0, .io_B8);
    pub const _15 = Pin.init_io(14, "15", 0, .io_B10);
    pub const _16 = Pin.init_io(15, "16", 0, .io_B12);
    pub const _17 = Pin.init_io(16, "17", 0, .io_B14);
    ...
    pub const _21 = Pin.init_io(20, "21", 1, .io_C2);
    pub const _22 = Pin.init_io(21, "22", 1, .io_C4);
    pub const _23 = Pin.init_io(22, "23", 1, .io_C6);
    pub const _24 = Pin.init_io(23, "24", 1, .io_C8);
    pub const _25 = Pin.init_misc(24, "25", null, .tms);
    pub const _26 = Pin.init_io(25, "26", 1, .io_C10);
    pub const _27 = Pin.init_io(26, "27", 1, .io_C12);
    pub const _28 = Pin.init_io(27, "28", 1, .io_C14);
    pub const _29 = Pin.init_misc(28, "29", 1, .gndo);
    pub const _30 = Pin.init_misc(29, "30", 1, .vcco);
    pub const _31 = Pin.init_io(30, "31", 1, .io_D0);
    pub const _32 = Pin.init_io(31, "32", 1, .io_D2);
    pub const _33 = Pin.init_io(32, "33", 1, .io_D4);
    pub const _34 = Pin.init_io(33, "34", 1, .io_D6);
    ...
    pub const _38 = Pin.init_io(37, "38", 1, .io_D8);
    pub const _39 = Pin.init_io(38, "39", 1, .io_D10);
    pub const _40 = Pin.init_io(39, "40", 1, .io_D12);
    pub const _41 = Pin.init_oe(40, "41", 1, .io_D14, 1);
    ...
    pub const _45 = Pin.init_io(44, "45", 0, .io_A2);
    pub const _46 = Pin.init_io(45, "46", 0, .io_A4);
    pub const _47 = Pin.init_io(46, "47", 0, .io_A6);
    pub const _48 = Pin.init_io(47, "48", 0, .io_A8);
};
