//[[!! include('devices', 'LC4032ZC_csBGA56') !! 470 ]]
...
pub const pins = struct {
    ...
    pub const A6 = Pin.init_oe(5, "A6", 1, .io_B15, 1);
    pub const A7 = Pin.init_io(6, "A7", 1, .io_B12);
    pub const A8 = Pin.init_misc(7, "A8", null, .no_connect);
    ...
    pub const B10 = Pin.init_misc(11, "B10", null, .no_connect);
    pub const C1 = Pin.init_io(12, "C1", 0, .io_A6);
    pub const C3 = Pin.init_io(13, "C3", 0, .io_A5);
    pub const C4 = Pin.init_oe(14, "C4", 0, .io_A0, 0);
    pub const C5 = Pin.init_clk(15, "C5", 1, .clk3, 3, 1);
    pub const C6 = Pin.init_io(16, "C6", 1, .io_B14);
    pub const C7 = Pin.init_io(17, "C7", 1, .io_B13);
    pub const C8 = Pin.init_misc(18, "C8", null, .gnd);
    pub const C10 = Pin.init_io(19, "C10", 1, .io_B11);
    pub const D1 = Pin.init_io(20, "D1", 0, .io_A7);
    pub const D3 = Pin.init_misc(21, "D3", 0, .gndo);
    pub const D8 = Pin.init_io(22, "D8", 1, .io_B9);
    pub const D10 = Pin.init_io(23, "D10", 1, .io_B10);
    pub const E1 = Pin.init_misc(24, "E1", null, .no_connect);
    pub const E3 = Pin.init_misc(25, "E3", null, .no_connect);
    pub const E8 = Pin.init_misc(26, "E8", 1, .vcco);
    pub const E10 = Pin.init_io(27, "E10", 1, .io_B8);
    pub const F1 = Pin.init_io(28, "F1", 0, .io_A8);
    pub const F3 = Pin.init_misc(29, "F3", 0, .vcco);
    pub const F8 = Pin.init_misc(30, "F8", null, .no_connect);
    pub const F10 = Pin.init_misc(31, "F10", null, .no_connect);
    pub const G1 = Pin.init_io(32, "G1", 0, .io_A10);
    pub const G3 = Pin.init_io(33, "G3", 0, .io_A9);
    pub const G8 = Pin.init_misc(34, "G8", 1, .gndo);
    pub const G10 = Pin.init_io(35, "G10", 1, .io_B7);
    pub const H1 = Pin.init_io(36, "H1", 0, .io_A11);
    pub const H3 = Pin.init_misc(37, "H3", null, .gnd);
    pub const H4 = Pin.init_io(38, "H4", 0, .io_A13);
    pub const H5 = Pin.init_io(39, "H5", 0, .io_A14);
    pub const H6 = Pin.init_clk(40, "H6", 0, .clk1, 1, 0);
    pub const H7 = Pin.init_io(41, "H7", 1, .io_B0);
    pub const H8 = Pin.init_io(42, "H8", 1, .io_B5);
    pub const H10 = Pin.init_io(43, "H10", 1, .io_B6);
    pub const J1 = Pin.init_misc(44, "J1", null, .no_connect);
    ...
    pub const K3 = Pin.init_misc(48, "K3", null, .no_connect);
    pub const K4 = Pin.init_io(49, "K4", 0, .io_A12);
    pub const K5 = Pin.init_io(50, "K5", 0, .io_A15);
    pub const K6 = Pin.init_clk(51, "K6", 1, .clk2, 2, 1);
    pub const K7 = Pin.init_io(52, "K7", 1, .io_B1);
    pub const K8 = Pin.init_io(53, "K8", 1, .io_B2);
    pub const K9 = Pin.init_io(54, "K9", 1, .io_B3);
    pub const K10 = Pin.init_io(55, "K10", 1, .io_B4);
};
