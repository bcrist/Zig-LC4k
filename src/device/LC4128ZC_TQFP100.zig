//[[!! include('devices', 'LC4128ZC_TQFP100') !! 775 ]]
...
pub const GRP = enum (u16) {
    ...
    pub inline fn maybe_mc(self: GRP) ?lc4k.MC_Ref {
        return switch (@intFromEnum(self)) {
            @intFromEnum(GRP.io_A0)...@intFromEnum(GRP.io_A14) => .{ .glb = 0, .mc = @intFromEnum(self) - @intFromEnum(GRP.io_A0) },
            @intFromEnum(GRP.mc_A0)...@intFromEnum(GRP.mc_A15) => .{ .glb = 0, .mc = @intFromEnum(self) - @intFromEnum(GRP.mc_A0) },
            @intFromEnum(GRP.io_B0)...@intFromEnum(GRP.io_B14) => .{ .glb = 1, .mc = @intFromEnum(self) - @intFromEnum(GRP.io_B0) },
            @intFromEnum(GRP.mc_B0)...@intFromEnum(GRP.mc_B15) => .{ .glb = 1, .mc = @intFromEnum(self) - @intFromEnum(GRP.mc_B0) },
            @intFromEnum(GRP.io_C0)...@intFromEnum(GRP.io_C14) => .{ .glb = 2, .mc = @intFromEnum(self) - @intFromEnum(GRP.io_C0) },
            @intFromEnum(GRP.mc_C0)...@intFromEnum(GRP.mc_C15) => .{ .glb = 2, .mc = @intFromEnum(self) - @intFromEnum(GRP.mc_C0) },
            @intFromEnum(GRP.io_D0)...@intFromEnum(GRP.io_D14) => .{ .glb = 3, .mc = @intFromEnum(self) - @intFromEnum(GRP.io_D0) },
            @intFromEnum(GRP.mc_D0)...@intFromEnum(GRP.mc_D15) => .{ .glb = 3, .mc = @intFromEnum(self) - @intFromEnum(GRP.mc_D0) },
            @intFromEnum(GRP.io_E0)...@intFromEnum(GRP.io_E14) => .{ .glb = 4, .mc = @intFromEnum(self) - @intFromEnum(GRP.io_E0) },
            @intFromEnum(GRP.mc_E0)...@intFromEnum(GRP.mc_E15) => .{ .glb = 4, .mc = @intFromEnum(self) - @intFromEnum(GRP.mc_E0) },
            @intFromEnum(GRP.io_F0)...@intFromEnum(GRP.io_F14) => .{ .glb = 5, .mc = @intFromEnum(self) - @intFromEnum(GRP.io_F0) },
            @intFromEnum(GRP.mc_F0)...@intFromEnum(GRP.mc_F15) => .{ .glb = 5, .mc = @intFromEnum(self) - @intFromEnum(GRP.mc_F0) },
            @intFromEnum(GRP.io_G0)...@intFromEnum(GRP.io_G14) => .{ .glb = 6, .mc = @intFromEnum(self) - @intFromEnum(GRP.io_G0) },
            @intFromEnum(GRP.mc_G0)...@intFromEnum(GRP.mc_G15) => .{ .glb = 6, .mc = @intFromEnum(self) - @intFromEnum(GRP.mc_G0) },
            @intFromEnum(GRP.io_H0)...@intFromEnum(GRP.io_H14) => .{ .glb = 7, .mc = @intFromEnum(self) - @intFromEnum(GRP.io_H0) },
